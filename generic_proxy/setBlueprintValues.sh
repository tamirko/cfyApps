...
export PRIMARY_NAME=FIREWALL_70
...
export SECONDARY_NAME=ROUTER_89
...
export SECONDARY_DEVICE_ELEMENT1_NAME=ROUTING_TABLE_03
# Replace the value with: Secondary device's 2nd element's name
export SECONDARY_DEVICE_ELEMENT2_NAME=ROUTING_TABLE_17
