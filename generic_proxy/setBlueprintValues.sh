...
export PRIMARY_NAME=FIREWALL_71
...
export SECONDARY_NAME=ROUTER_892
...
export SECONDARY_DEVICE_ELEMENT1_NAME=ROUTING_TABLE_06
# Replace the value with: Secondary device's 2nd element's name
export SECONDARY_DEVICE_ELEMENT2_NAME=ROUTING_TABLE_19
